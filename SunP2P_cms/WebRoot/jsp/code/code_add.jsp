...
<html>
	...
	<body>
		<form id="form" name="form" method="post" action="returnCodeAction_add" >
			...
			<ul class="main-actions clearfix">
		        <li> 
					...
					<input name="returnCode.return_code" type="text"  class="required tool-text"/>
			     </li>
				<li>
					<label class="extra">返回信息：</label>
					<input name="returnCode.return_msg" type="text" class="required  tool-text" />
				</li>
			</ul>
