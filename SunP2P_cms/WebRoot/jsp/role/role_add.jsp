...
<div class="window-pop">
	<!--显示表单内容-->
	<form action="roleAction_addRole" method="post" id="roleAdd" >
	<ul class="pop-list">
		<li>
			<label><span style="color: red"> *</span>角色ID：</label> 
			<input class="tool-text" type="text" name="role_id" id="role_id" />			
		</li>
		<li>
			<label><span style="color: red"> *</span>角色名称：</label> 
			<input class="tool-text" type="text" name="role_name" id="role_name" />
		</li>
		<li>
			<label>说明：</label> 
			<input class="tool-text" type="text" name="role_desc" id="role_desc" />		
		</li>
	</ul>
