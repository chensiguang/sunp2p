...
<html>
	...
	<form name="form" method="post" action="fundInfoAction_check" onsubmit="return doPass();">
		...
		<ul id="mainAction" class="main-actions clearfix">
			<li>
				...
				<input class="tool-text" name="fundInfo.prod_id" type="text"  value="${fundInfo.prod_id}" />
			</li>
			<li>
			...
			<li>
				...
				<input class="tool-text" name="fundInfo.net_date" type="text" value="${fundInfo.net_date}" />
			</li>
			<li>
