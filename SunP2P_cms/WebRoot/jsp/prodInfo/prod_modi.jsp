...
<html>
	...
	<form name="form" id="form" method="post" action="prodInfoAction_modi" onsubmit="getCheckBoxVal()">
		...
		<ul class="main-actions clearfix">
			...
			<li>
				...
				<input class="required digits tool-text" name="prodInfo.cycle" value="${prod.cycle }" type="text" id="cycle" onkeyup="show_readonly()"/>
			</li>
			<li>
