...
<html>
	...
	<form name="form" method="post" action="p2pInfoAction_check" onsubmit="return doPass();">
		...
		<ul class="main-actions clearfix">
			...
			<li>
				...
				<input class="tool-text" name="p2pInfo.value_date" type="text" value="${p2pInfo.value_date}" />
			</li>
			<li>
				<label class="extra">产品到期日：</label>
				<input class="tool-text" name="p2pInfo.expire_date" type="text" value="${p2pInfo.expire_date}" />
			</li>
			<li>
