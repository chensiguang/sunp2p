...
public class DateUtil {
	...
	public static java.util.Date parseDate(String dateStr) {
		return parseDate(dateStr, Consts.DATE_FORMATTER);
	}
	...
	public static String todayStr() {
		return formatDateToStr(new Date(), Consts.DATE_FORMATTER);
	}
	...
	public static Date today() {
		return parseDate(todayStr(), Consts.DATE_FORMATTER);
	}
	...
	public static String formatDateToStr(Date date) {
		return formatDateToStr(date, Consts.DATE_FORMATTER);
	}
	...
	public static String getMonth() {
		...
		cal.add(Calendar.MONTH, -Consts.MONTH_INV);
		long date = cal.getTimeInMillis();
		return formatDateToStr(new Date(date));
	}
	/**
	 * 获取本月第一天
	 * @return
	...
	public static String getDatePreHours(int preHours) {
		...
		Date date = new Date();
		// 格式化对象
		SimpleDateFormat sdf = new SimpleDateFormat(Consts.DATE_FORMATTER
				+ " HH:mm:ss");
		// 日历对象
		Calendar calendar = Calendar.getInstance();
		// 设置当前日期
